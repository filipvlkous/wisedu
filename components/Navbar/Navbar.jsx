...
export default function Example() {
  ...
  useEffect(() => {
    const onScroll = () => console.log("dsd");
          ...
          <div className="relative flex items-center justify-between h-16">
            <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
              ...
              <Disclosure.Button
                ...
                className="inline-flex items-center justify-center p-2 rounded-md text-primary hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
              >
              ...
              <Link href="/">
                <div className="flex-shrink-0 flex items-center">
                  <Image
                    ...
                    src={JustLogo}
                    alt="Only Wisdom Education logo"
                  />
                  ...
                  <Image
                    ...
                    src={Logo}
                    alt="Wisdom Education Logo with text"
                  />
                </div>
              </Link>
